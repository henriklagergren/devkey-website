const ThermometerAppPrivacyPolicy = () => {
  return (
    <div style={{ padding: 16 }}>
      <body>
        <strong>Privacy Policy</strong>{" "}
        <p>
          devKey Software built the Thermometer 24/7 app as a Free app. This
          SERVICE is provided by devKey Software at no cost and is intended for
          use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Thermometer 24/7 unless
        ...
        <p>This policy is effective as of 2023-12-01</p>{" "}
        <p>
          <strong>Contact Us</strong>
        </p>{" "}
        <p>
          If you have any questions or suggestions about our Privacy Policy, do
          not hesitate to contact us at henrik@devkey.se.
        </p>{" "}
      </body>
    </div>
  );
...
export default ThermometerAppPrivacyPolicy;
